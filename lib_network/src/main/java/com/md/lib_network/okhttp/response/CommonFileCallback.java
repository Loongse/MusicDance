...
import com.md.lib_network.okhttp.response.listener.DisposeDownloadListener;
...
public class CommonFileCallback implements Callback {
    ...
    private Handler mDeliveryHandler;//交付handler
    ...
    private File handleResponse(Response response) {
        ...
        int length;
        int currentLength = 0;//当前进度
        double sumLength;//总大小
        try {
