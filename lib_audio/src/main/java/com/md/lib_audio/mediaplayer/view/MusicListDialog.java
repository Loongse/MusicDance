...
import com.md.lib_audio.mediaplayer.core.AudioController.PlayMode;
...
import com.md.lib_audio.mediaplayer.view.adapter.MusicListAdapter;
...
public class MusicListDialog extends BottomSheetDialog {
    ...
    private TextView mPlayedModeView;
    ...
    private void intiView() {
        ...
        mPlayedModeView = findViewById(R.id.mode_text_view);
        mPlayedModeView.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void updatePlayModeView() {
        switch (mPlayMode) {
            case LOOP:
                ...
                mPlayedModeView.setText("列表循环");
                break;
            case RANDOM:
                mTipView.setImageResource(R.mipmap.random);
                mPlayedModeView.setText("随机播放");
                break;
            case REPEAT:
                mTipView.setImageResource(R.mipmap.once);
                mPlayedModeView.setText("单曲循环");
                break;
        }
    }
