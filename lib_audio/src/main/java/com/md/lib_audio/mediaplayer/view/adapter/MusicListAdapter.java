package com.md.lib_audio.mediaplayer.view.adapter;
...
public class MusicListAdapter extends RecyclerView.Adapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        return new MyViewHolder(
                LayoutInflater.from(viewGroup.getContext())
                        .inflate(R.layout.dialog_bottom_sheet_item, null)
        );
    }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int position) {
        ...
        myViewHolder.author.setText(new StringBuilder()
                .append(" ").append("-").append(" ").append(bean.author));
