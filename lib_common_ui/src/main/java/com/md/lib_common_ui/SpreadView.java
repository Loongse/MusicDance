...
public class SpreadView extends View {
    ...
    private int delayMillSeconds = 33;//扩散延迟间隔，越大扩散越慢
    private List<Integer> spreadRadius = new ArrayList<>();//扩散圆层级数，元素为扩散的距离
    private List<Integer> alphas = new ArrayList<>();//每层的透明度
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //延迟更新，形成视觉差效果
        postInvalidateDelayed(delayMillSeconds);
